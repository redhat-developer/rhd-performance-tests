...
function run_tests_in_docker {
  export PROPERTIES="-DdrupalUser=$RHD_DRUPAL_USER -DdrupalUserPassword=$RHD_DRUPAL_PASSWORD -DbaseUrl=$RHD_PERF_TEST_URL -DmaxDuration=$RHD_MAX_DURATION -DrampUpUsers=$RHD_USER_RAMP -DnoAdmins=$RHD_ADMIN_RAMP"
